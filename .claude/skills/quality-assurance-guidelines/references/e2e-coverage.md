...
- MUST flag a Critical when the diff adds a new route or top-level entry point without an asserting suite under `e2e/`.
...
- MUST flag a new test file placed outside the `e2e/` purpose-based layout per [e2e-testing-guidelines › structure](../../e2e-testing-guidelines/references/structure.md).
