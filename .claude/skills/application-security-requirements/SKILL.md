...
description: The security and privacy review lens for code changes. Covers secrets/env vars, Next.js's NEXT_PUBLIC_ client-exposed env-var prefix, input validation, public exposure, output-encoding/injection in rendered untrusted content, SSRF/outbound fetch of user-controlled URLs, error-reporting data capture, and dependency supply-chain risk.
