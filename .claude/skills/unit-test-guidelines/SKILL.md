...
- keeping pure helper tests small while routing browser and framework behavior to broader tests
...
- SHOULD prefer integration or e2e tests when confidence depends on framework runtime wiring, persistence, browser behavior, rendering, routing, or user-facing UI.
